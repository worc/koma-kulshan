...
export default [
    {
        ...
        specific: [
            'an elderly traveler heading to the city with an heirloom, they ask to travel with the party, 1 in 4 chance they die in the night',
            'a bard with a beautiful but cursed instrument',
            'a hunter that mistakes the party for the game that they\'re tracking',
            'a wizard on the run from the law',
